...
def FindAdmin_panel():
    possiblity = (
        'admin','admin.php',"admin/index.php","login/index.php","login.php",
        "administrator","administrator.php","login/admin.php","login/administrator.php","members",
        "login/members","administration","administration/login.html","webadmin/login",'moderator/login.html',
        ...
        'modelsearch/login.asp','moderator.asp','moderator/login.asp','administrator/login.asp','moderator/admin.asp',
        'controlpanel.asp','admin/account.html','adminpanel.html','webadmin.html','administration',
